...
#
# example: -l mem_free=12G,act_mem_free=12G,h_vmem=16G
...
source /lnet/express/work/people/stankov/python-venvs/torch-cpu/bin/activate
echo ">>>> running python"
python /lnet/express/work/people/stankov/alignment/Thesis/hubert/create_subset.py
